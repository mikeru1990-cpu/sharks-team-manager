...
import { Radar, Route, Target } from "lucide-react"
...
export default function AdvancedTacticalSimulator() {
  return (
    <OperationalCard
      title="Advanced Tactical Simulator"
      subtitle="Predictive tactical simulation engine"
    >
      <div
        style={{
          display: "flex",
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  >
                    Tactical simulation engine active
                  </div>
                </div>
              </div>
