...
const U10_PLAYER_NAMES = new Set([
...
const U11_PLAYER_NAMES = new Set([
  "lyra twinning",
  "bella bainbridge",
  "betsy rowland",
  "connie luff",
...
export default function DashboardShell(props: Props) {
  ...
  const scopedProps = useMemo(() => {
    ...
    return {
      ...
      matchPlayers: filterPlayersByTeam(props.matchPlayers || props.players, activeTeamId),
      maybePlayers: filterPlayersByTeam(props.maybePlayers || [], activeTeamId),
      unavailablePlayers: filterPlayersByTeam(props.unavailablePlayers || [], activeTeamId),
      attendance: filterAttendanceByPlayers(props.attendance, scopedPlayers),
