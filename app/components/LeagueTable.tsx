          ...
          <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 760 }}>
            ...
            <tbody>
              {standings.map((row, index) => {
                const isOurTeam =
                  teamName.trim() &&
                  row.team.toLowerCase().includes(teamName.trim().toLowerCase())
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: "10px 8px" }}>{row.goal_difference}</td>
                    <td style={{ padding: "10px 8px", fontWeight: 900 }}>{row.points}</td>
                  </tr>
                )
              })}
            </tbody>
