...
const recoverySystems = [
  {
    title: "Formation Recovery",
    status: "Ready",
    icon: RotateCcw,
    color: "#3b82f6",
  },
  {
    title: "Player Recovery Sync",
    status: "Protected",
    icon: ShieldCheck,
    color: "#22c55e",
  },
  {
    title: "State Rollback Engine",
    status: "Available",
    icon: TimerReset,
    color: "#8b5cf6",
  },
...
export default function TacticalRecoverySystem() {
  return (
    <OperationalCard
      title="Tactical Recovery System"
      subtitle="Automated tactical rollback and recovery"
    >
      <div
        style={{
          display: "flex",
