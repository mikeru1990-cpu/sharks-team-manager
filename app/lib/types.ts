...
export const initialPlayers: Player[] = [
  { id: "1", name: "Lyra Twinning", positions: ["FWD"], mainGK: false, backupGK: false, captain: true, viceCaptain: false, seasonSeconds: 0 },
  { id: "2", name: "Bella Bainbridge", positions: ["MID"], mainGK: false, backupGK: false, captain: false, viceCaptain: true, seasonSeconds: 0 },
  { id: "3", name: "Betsy Rowland", positions: ["MID"], mainGK: false, backupGK: false, captain: false, viceCaptain: false, seasonSeconds: 0 },
  { id: "4", name: "Ella Wilson", positions: ["MID", "DEF"], mainGK: false, backupGK: false, captain: false, viceCaptain: false, seasonSeconds: 0 },
  { id: "5", name: "Bailee Dowler-Rowles", positions: ["DEF"], mainGK: false, backupGK: false, captain: false, viceCaptain: false, seasonSeconds: 0 },
  { id: "6", name: "Evelyn Evans", positions: ["DEF"], mainGK: false, backupGK: false, captain: false, viceCaptain: false, seasonSeconds: 0 },
  { id: "7", name: "Darcy-Rae Russell", positions: ["GK"], mainGK: true, backupGK: false, captain: false, viceCaptain: false, seasonSeconds: 0 },
  { id: "8", name: "Isabella Ogden", positions: ["MID", "FWD"], mainGK: false, backupGK: false, captain: false, viceCaptain: false, seasonSeconds: 0 },
  { id: "9", name: "Martha Scrivens", positions: ["MID"], mainGK: false, backupGK: false, captain: false, viceCaptain: false, seasonSeconds: 0 },
  { id: "10", name: "Poppy Bennett", positions: ["GK"], mainGK: false, backupGK: true, captain: false, viceCaptain: false, seasonSeconds: 0 },
]
