...
const items: Array<{ key: MainTab; label: string; shortLabel: string; icon: React.ReactNode }> = [
  ...
  { key: "players", label: "Player workspace", shortLabel: "Players", icon: <UsersIcon size={18} /> },
